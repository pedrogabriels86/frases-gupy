...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* AJUSTE DO TOPO PARA COLAR NA TELA */
    .block-container {
    ...
    /* --- MENU LATERAL (COLUNA 1) --- */
    div[data-testid="column"]:nth-of-type(1) {
        background-color: #00122F;
        padding: 2rem 1.5rem; /* Espaçamento interno */
        min-height: 100vh; /* Força altura total da tela */
    ...
    div[data-testid="column"]:nth-of-type(2) {
        padding-top: 2rem; /* Conteúdo começa um pouco mais baixo */
        padding-left: 1rem;
    }

    /* ESTILO DO RADIO BUTTON (MENU) */
    ...
    .stRadio div[role="radiogroup"] > label[data-checked="true"] {
        ...
        color: white !important;
        font-weight: 600;
        box-shadow: 0 4px 10px rgba(33, 117, 217, 0.4);
    }
    /* Esconde bolinha do radio */
    ...
    .card-container, div[data-testid="stVerticalBlock"] > div[style*="border"] {
        ...
        box-shadow: 0 2px 5px rgba(0,0,0,0.03); padding: 20px !important;
    }
...
if st.session_state["usuario_logado"] is None:
    ...
    # --- LAYOUT DE COLUNAS AJUSTADO [MENU, GAP, CONTEUDO] ---
    # Aqui está o segredo da divisão melhor: [1, 5] é uma proporção mais elegante
    col_menu, col_content = st.columns([1, 5], gap="medium")
    ...
    with col_menu:
        ...
        # Perfil Simplificado
        st.markdown(f"<div style='font-size:0.8rem; opacity:0.7'>BEM-VINDO(A)</div><div style='font-weight:600; font-size:1.1rem; margin-bottom:20px'>{user['username']}</div>", unsafe_allow_html=True)
            ...
            # --- 2. GESTÃO ---
                ...
                with st.expander("➕  Adicionar Nova Frase", expanded=False):
                    with st.form("quick_add"):
                        ...
                        nc = st.text_area("Conteúdo", height=100)
                ...
                q = cs.text_input("🔎 Buscar...", placeholder="Digite para filtrar")
