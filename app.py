...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* ESCONDER ITENS PADRÃO DO STREAMLIT */
    [data-testid="stHeader"] { display: none; }
    [data-testid="stSidebar"] { display: none; } /* Esconde a sidebar nativa */
    footer { display: none; }
    ...
    /* --- ESTILO DA COLUNA DO MENU (ESQUERDA) --- */
    /* Esse seletor pega a primeira coluna da tela */
    div[data-testid="column"]:nth-of-type(1) {
        background-color: #00122F; /* Azul Gupy Escuro */
        padding: 20px;
        border-radius: 12px;
        color: white;
        min-height: 90vh; /* Altura da tela */
    }
    
    /* Textos dentro do Menu */
    ...
    div[data-testid="stVerticalBlock"] > div[style*="border"] {
        ...
        box-shadow: 0 1px 2px rgba(0,0,0,0.05); padding: 20px !important;
    }
...
if st.session_state["usuario_logado"] is None:
    ...
    # --- LAYOUT DE COLUNAS (AQUI CRIA O MENU SEPARADO) ---
    # col_menu (15%) | col_content (85%)
    col_menu, col_content = st.columns([1.5, 6])
